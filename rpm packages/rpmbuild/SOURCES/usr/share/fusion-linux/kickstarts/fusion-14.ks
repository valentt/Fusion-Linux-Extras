...
#repo --name=scribus --baseurl=http://download.opensuse.org/repositories/home:/mrdocs/Fedora_14/
...
sed -i -e 's/Fedora/Fusion/g' /etc/fedora-release /etc/issue
...
/desktop/gnome/application/browser/exec
gconftool-2 --direct --config-source=xml:readwrite:/etc/gconf/gconf.xml.defaults -s -t string /desktop/gnome/application/browser/exec chromium-browser > /dev/null
...
name=mintMenu
type=rpm-md
baseurl=http://download.opensuse.org/repositories/home:/unamanic/Fedora_$releasever/
gpgcheck=1
gpgkey=http://download.opensuse.org/repositories/home:/unamanic/Fedora_$releasever/repodata/repomd.xml.key
enabled=1
#exclude=mintmenu-5*
EOF
...
# install Scribus repository
#wget http://download.opensuse.org/repositories/home:/mrdocs/Fedora_14/repodata/repomd.xml.key
#rpm --import repomd.xml.key
#cat >> /etc/yum.repos.d/scribus.repo << EOF
#[scribus]
#name=Scribus (Fedora_14)
#type=rpm-md
#baseurl=http://download.opensuse.org/repositories/home:/mrdocs/Fedora_14/
#gpgcheck=1
#gpgkey=http://download.opensuse.org/repositories/home:/mrdocs/Fedora_14/repodata/repomd.xml.key
#enabled=1
#EOF
...
# Download and Install Arista Encoder, 7 M
cd "$LIVE_ROOT"
