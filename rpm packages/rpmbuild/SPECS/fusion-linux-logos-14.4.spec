...
Source0:    http://iso.linux.hr/fusion-linux/fusion-repo/fusion-14/%{name}/%{name}-%{version}.tar.gz
...
install -p -m 644 backgrounds/fusion-linux/fusion-linux.xml $RPM_BUILD_ROOT%{_datadir}/backgrounds/fusion-linux/
...
%post
cp /usr/share/backgrounds/images/
...
%changelog
* Sun Mar 06 2011 Valent Turkovic <valent.turkovic@gmail.com> - 14.4-1
- Added new anaconda and bootsplash graphics with Fusion logo by Hugo
- Fixed Rei-Forever background xml bug
